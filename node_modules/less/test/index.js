...
var testMap = [
    ...
    [{rootpath: 'http://example.com/assets/old/css/', rewriteUrls: 'all'}, 'rootpath-rewrite-urls-all/'],
    [{rootpath: 'http://example.com/assets/old/css/', rewriteUrls: 'local'}, 'rootpath-rewrite-urls-local/'],
